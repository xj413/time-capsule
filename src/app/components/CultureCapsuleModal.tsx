      ...
      >
        ...
        <div className="flex border-b border-slate-700 bg-slate-900 overflow-x-auto scrollbar-hide">
          <button
            ...
            className={`flex-1 min-w-max whitespace-nowrap px-4 flex items-center justify-center gap-2 py-4 text-sm font-medium transition-colors relative ${activeTab === 'history' ? 'text-amber-400' : 'text-amber-100/50 hover:text-amber-100/80'}`}
          >
          ...
          <button
            ...
            className={`flex-1 min-w-max whitespace-nowrap px-4 flex items-center justify-center gap-2 py-4 text-sm font-medium transition-colors relative ${activeTab === 'life' ? 'text-amber-400' : 'text-amber-100/50 hover:text-amber-100/80'}`}
          >
          ...
          <button
            ...
            className={`flex-1 min-w-max whitespace-nowrap px-4 flex items-center justify-center gap-2 py-4 text-sm font-medium transition-colors relative ${activeTab === 'food' ? 'text-amber-400' : 'text-amber-100/50 hover:text-amber-100/80'}`}
          >
          ...
          <button
            ...
            className={`flex-1 min-w-max whitespace-nowrap px-4 flex items-center justify-center gap-2 py-4 text-sm font-medium transition-colors relative ${activeTab === 'clothing' ? 'text-amber-400' : 'text-amber-100/50 hover:text-amber-100/80'}`}
          >
          ...
          <button
            ...
            className={`flex-1 min-w-max whitespace-nowrap px-4 flex items-center justify-center gap-2 py-4 text-sm font-medium transition-colors relative ${activeTab === 'traditions' ? 'text-amber-400' : 'text-amber-100/50 hover:text-amber-100/80'}`}
          >
          ...
          <button
            ...
            className={`flex-1 min-w-max whitespace-nowrap px-4 flex items-center justify-center gap-2 py-4 text-sm font-medium transition-colors relative ${activeTab === 'community' ? 'text-amber-400' : 'text-amber-100/50 hover:text-amber-100/80'}`}
          >
